...
import argparse,json,os,subprocess,tempfile,time,winreg,threading,ctypes,hashlib
...
def verify(compiler,report):
    ...
    result={'passed':False,'target':'native installer with readiness fixtures',
            ...
            'installer_template_sha256':hashlib.sha256((ROOT/'packaging/windows-installer.nsi').read_bytes()).hexdigest(),
            'upgrade_helper_sha256':hashlib.sha256((ROOT/'packaging/upgrade-launch.ps1').read_bytes()).hexdigest()}
