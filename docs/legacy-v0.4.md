> **旧版文档归档 · v0.4.2**
>
> 以下为 V3 重构前的使用说明，源自提交 `e6b5b085d055d6f4306d486fb6d8e3cd5dfa84d5`。它描述旧版功能，不是 V3 开发规范。相对许可证链接及下载入口已调整，其余正文保留。关于隐私：同一局域网不代表传输加密；语音处理仍取决于你使用的输入法服务。
>
> [返回项目首页](../README.md) · [v0.4.2 发布页](https://github.com/aaakoako/DoubaoTypeless/releases/tag/v0.4.2)
...
[![Releases](https://img.shields.io/github/v/release/aaakoako/DoubaoTypeless?label=release)](https://github.com/aaakoako/DoubaoTypeless/releases/tag/v0.4.2)
...
**免编译尝鲜：** 直接下 [Releases](https://github.com/aaakoako/DoubaoTypeless/releases/tag/v0.4.2) 里的 **`DoubaoTypeless.exe`** 或 **`DoubaoTypeless_win_portable.zip`**。
