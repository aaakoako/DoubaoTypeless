...
**0.5.4 修订中：图文连续输入、完整安装升级和可选输入检查。** 从 [GitHub Releases](https://github.com/aaakoako/DoubaoTypeless/releases) 获取已发布版本。用户已确认 Codex 桌面端连续图文插入；其他输入框、手机浏览器和输入法的兼容性请以实际使用为准。
